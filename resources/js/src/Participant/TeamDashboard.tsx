          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1">
              ...
              <Card className="mt-6">
                ...
                <CardContent>
                  <p className="text-gray-300 mb-4">Join our Discord community to connect with other participants, get updates, and ask questions.</p>
                  <a 
                    href="https://discord.com/invite/ApD3shP5cr" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-white bg-[#5865F2] hover:bg-[#4752C4] rounded-md transition-colors"
                  >
