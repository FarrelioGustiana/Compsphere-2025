...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
    ...
    const navigation = {
        participant: [
            { name: 'Dashboard', href: route('participant.dashboard'), icon: Home },
    ...
    const currentNavigation = navigation[userRole as keyof typeof navigation] || navigation.participant;
                ...
                <div className="relative flex-1 flex flex-col max-w-xs w-full bg-gray-800">
                    ...
                    <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                        <div className="flex-shrink-0 flex items-center px-4">
                            <span className="text-xl font-bold text-white">Compsphere 2025</span>
                        </div>
                        ...
                        <div className="flex-shrink-0 group block">
                            <div className="flex items-center">
                                ...
                                <div className="ml-3">
                                    ...
                                    <p className="text-sm font-medium text-gray-400 capitalize">{auth.user?.role}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex-shrink-0 w-full group block">
                            <div className="flex items-center">
                                ...
                                <div className="ml-3">
                                    ...
                                    <p className="text-xs font-medium text-gray-400 capitalize">{auth.user?.role}</p>
                                </div>
                            </div>
                        </div>
                    </div>
