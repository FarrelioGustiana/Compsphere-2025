...
export default function AdminManagement({ admins }: Props & PageProps) {
    ...
    const confirmDelete = (adminId: number) => {
        setConfirmingDelete(adminId);
    };

    const handleDelete = (adminId: number) => {
        deleteAdmin(route("admin.manage.users.delete", { user: adminId }), {
            onSuccess: () => {
                ...
                <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    <div className="p-6">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <Link
                                href={route("admin.manage.admins.create")}
