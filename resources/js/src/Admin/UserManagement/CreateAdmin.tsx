...
export default function CreateAdmin({}: PageProps) {
                ...
                <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    <div className="p-6">
                        <div className="mb-6">
                            ...
                            >
                                <ArrowLeft className="h-4 w-4 mr-1" /> Back to Admin Management
                            </a>
                        </div>

                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Create Moderator Admin</h2>
