                    ...
                    <div className="container mx-auto px-4 md:px-16 lg:px-24 flex items-center justify-center h-full">
                        <div className="w-full border border-white/70 bg-black/30 p-6 md:p-10 flex flex-col relative">
                            ...
                            <div className="md:hidden flex flex-col">
                                ...
                                >
                                    <h2 className="text-2xl font-airborne tracking-wide mb-4">DATE & LOCATION</h2>
                                    <div className="space-y-2">
                                        <p className="text-base"><span className="font-semibold">Date & Time:</span> 4 October 2025</p>
                                        <p className="text-base"><span className="font-semibold">Location:</span> Charles Hermawan Auditorium,</p>
                                    </div>
                                </motion.div>
                            ...
                            <div className="hidden md:block">
                                ...
                                <motion.div
                                    ...
                                    transition={{ duration: 0.8, delay: 0.8 }}
                                >
                                    <h2 className="text-2xl md:text-3xl font-airborne tracking-wide mb-4">DATE & LOCATION</h2>
                                    <div className="space-y-2">
                                        <p className="text-lg"><span className="font-semibold">Date & Time:</span> 4 October 2025</p>
                                        <p className="text-lg"><span className="font-semibold">Location:</span> Charles Hermawan Auditorium,</p>
                                    </div>
                                </motion.div>
                            </div>
                        </div>
